...
<img src="doc/ulhkwh_fastlio_modified.gif" width = 49.6% >
</div>
...
**Pipeline:**
<div align="center">
<img src="doc/overview_fastlio_modified2.svg" width=99% />
</div>
...
## 2. Build
If you want to use docker conatiner to run fastlio_modified2, please install the docker on you machine.
...
# Container name
CONTAINER_NAME="fastlio_modified2"
...
docker run -itd \
  ...
  --env="DISPLAY=$DISPLAY" \
  kenny0407/marslab_fastlio_modified2:latest \
  /bin/bash
```
...
```
    cd ~/$A_ROS_DIR$/src
    git clone https://github.com/dlduddn/FAST_LIO_modified.git
    cd FAST_LIO_modified
...
We produce [Rosbag Files](https://drive.google.com/drive/folders/1blQJuAB4S80NwZmpM6oALyHWvBljPSOE?usp=sharing) and [a python script](https://drive.google.com/file/d/1QC9IRBv2_-cgo_AEvL62E1ml1IL9ht6J/view?usp=sharing) to generate Rosbag files: ```python3 sensordata_to_rosbag_fastlio_modified.py bin_file_dir bag_name.bag```
