...
grid on
box on
% print('./Figures/fastlio_modified_exp_average','-depsc','-r600')
...
% print('./Figures/fastlio_modified_exp_combine','-depsc','-r1200')
% exportgraphics(f,'./Figures/fastlio_modified_exp_combine_1.pdf','ContentType','vector')
